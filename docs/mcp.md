...
- [`examples/mcp_example.py`](https://raw.githubusercontent.com/nerigleston/jangada-docs/main/examples/mcp_example.py) — cliente MCP.
- [`examples/mcp_server_example.py`](https://raw.githubusercontent.com/nerigleston/jangada-docs/main/examples/mcp_server_example.py) — **servidor** MCP (stdio).
